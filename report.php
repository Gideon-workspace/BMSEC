...
<html>
    <head>
        ...
        <h2>Upload your Results from Previous Grade</h2><br>
          ;
        <style>
           h2 {
    ...
    Type in your name and surname in the box below - it is very important so your previous grade results get lost in the system.
</p>

        <form action="uploadfile2.inc.php" method="post" enctype ="multipart/form-data">
        <div class ="container">
                <br><div class = "form">
